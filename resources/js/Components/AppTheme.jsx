...
//     // Apply the locale to the theme
//     return createTheme(baseTheme, locales[locale] || locales.enUS);
...
// export const AppThemeDashBoard = createTheme({
//     cssVariables: {
//       colorSchemeSelector: 'data-mui-color-scheme',
//       cssVarPrefix: 'template',
//     },
...
// export function AppThemeDashBoard({ children, disableCustomTheme, themeComponents,}) {
//     const theme = React.useMemo(() => {
//       return disableCustomTheme
//         ? {}
//         : createTheme({
