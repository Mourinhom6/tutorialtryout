    ...
    const handleAction = (key, id_blogs) => {
        ...
        switch (key) {
            case 'Visibility':
                ...
                router.patch(routing("blogs.update",{edit: 'id_blogs'}))
                //     preserveScroll: true,
                //     onSuccess: () => {
            ...
            case 'Edit':
                ...
                router.visit(routing('blogs.edit', id_blogs));
                break;
            case 'Delete':
                console.log(' Entrou Delete');
                router.delete(routing('blogs.destroy',id_blogs), {
                    onSuccess: () => {
            ...
            case 'Save':
                ...
                router.get(routing('blogs.show', { edit: id_blogs }));
                            ...
                            <SyledCard variant="outlined" sx={{ position: 'relative' }}>
                                ...
                                <SpeedDial
                                    ...
                                    <SpeedDialAction
                                        ...
                                        onClick={() => { setData('id', projects.id)} }
                                    ...
                                    <SpeedDialAction
                                        ...
                                        onClick={() => {router.get(routing('blogs.show', projects.id))}}
                                    />
                                        {/* <Link href={routing('blogs.show', projects.id)}></Link> */}
                                     {/* </SpeedDialAction> */}
                                    <SpeedDialAction
                                        key="Delete"
    ...
    >
      <Head title="Projects" />
        ...
        <div className="py-12">
            ...
            <Postsoffice mdsize={multiplier} blogs={dataproj.edits.data} /> {/* queryParams={queryParams} */}
                <Snackbar
                    anchorOrigin={{
                        vertical: 'bottom',
                        horizontal: 'center',
