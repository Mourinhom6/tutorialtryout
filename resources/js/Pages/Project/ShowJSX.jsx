...
export default function Show({ auth, success, project, tasks, queryParams, blog }) {
// export default function Show({ auth, success, queryParams, blog }) {
    ...
    >
        ...
        <div className="flex items-center justify-between">
            ...
            <Link
                // href={route("project.edit",{ project: blog.id })}
                href={route("project.edit", project.id)}
                    ...
                    <div className="p-6 text-gray-900 dark:text-gray-100">
                        <div className="grid gap-1 grid-cols-2 mt-2">
                            <div>
                                ...
                                <div className="mt-4">
                                    <label className="font-bold text-lg">Blog Name</label>
                                    <p className="mt-1">{blog.title}</p>
                                </div>
                                <div className="mt-4">
                                    <label className="font-bold text-lg">Blog State</label>
                                    <p className="mt-1">
                                        <span
                                            className={ "px-2 py-1 rounded text-white " + BLOG_STATUS_CLASS_MAP[blog.state]}>
                                            {BLOG_STATUS_TEXT_MAP[blog.state]}
                                        </span>
                                    </p>
                                </div>
                                <div className="mt-4">
