...
} from "./chunk-HML6AVJO.js";
import {
  Alert_default
} from "./chunk-LMUXGVVP.js";
import {
  IconButton_default
} from "./chunk-TZVXRQAY.js";
import {
  SnackbarContent_default,
  Snackbar_default
} from "./chunk-PSIM7QZH.js";
import {
  createPopper
} from "./chunk-SAIP4WZI.js";
import {
  InitColorSchemeScript_default,
  ThemeProvider,
  useColorScheme,
  useThemeProps
} from "./chunk-IERXAFQF.js";
import {
  ButtonGroupContext_default,
  Button_default
} from "./chunk-OAWFVZ43.js";
import {
  autoUpdate,
  flip,
  offset,
  shift,
  useFloating
} from "./chunk-JNYWXW2M.js";
import {
  Typography_default
} from "./chunk-UE4XEGRC.js";
import {
  require_react_dom
} from "./chunk-NUMECXU6.js";
import {
  isMuiElement_default
} from "./chunk-RYFTRXBO.js";
import {
  useId_default
} from "./chunk-VDVD3IRC.js";
import {
  createSvgIcon
} from "./chunk-BA24AUYC.js";
import {
  memoTheme_default
} from "./chunk-V4DF263K.js";
import {
  capitalize_default
} from "./chunk-RCMJYXNJ.js";
import {
  useDefaultProps
} from "./chunk-J2X3I66U.js";
import {
  createTheme,
  styled_default
} from "./chunk-XXNEXCPI.js";
import {
  HTMLElementType,
  chainPropTypes,
  clamp_default,
...
var Portal = React44.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React44.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React44.isValidElement(children)) {
      ...
      return React44.cloneElement(children, newProps);
    }
    return (0, import_jsx_runtime16.jsx)(React44.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime16.jsx)(React44.Fragment, {
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = React53.useContext(DropdownContext) ?? FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
  ...
  return (0, import_jsx_runtime21.jsx)(Portal, {
    ...
    children: (0, import_jsx_runtime21.jsxs)(Root, {
      ...
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime21.jsx)(BackdropComponent, {
        ...
        open,
        children: React57.cloneElement(children, childProps)
      })]
    })
  });
});
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime22.jsx)(React58.Fragment, {
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React59.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React59.useMemo(() => {
    return {
      min,
      max,
      step,
  ...
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React59.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var NumberInput = React60.forwardRef(function NumberInput2(props, forwardedRef) {
  const {
    className,
    defaultValue,
    disabled,
...
var InnerOption = React64.forwardRef(function InnerOption2(props, forwardedRef) {
  var _a, _b;
  const {
    children,
    disabled = false,
...
var InnerOptionMemo = React64.memo(InnerOption);
var Option = React64.forwardRef(function Option2(props, ref) {
  const {
    value
  } = props;
  const {
...
function useSelect(props) {
  ...
  const getItemDomElement = React66.useCallback((itemId) => {
    var _a;
    if (itemId == null) {
      return null;
    }
  ...
  const isInitiallyOpen = React66.useRef(open);
  useEnhancedEffect_default(() => {
    var _a;
...
function defaultRenderValue(selectedOptions) {
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime28.jsx)(React68.Fragment, {
...
var Select = React68.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime28.jsxs)(React68.Fragment, {
...
var Slider = React70.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsxs)(Root, {
    ...
    children: [(0, import_jsx_runtime29.jsx)(Rail, {
      ...
      return (0, import_jsx_runtime29.jsxs)(React70.Fragment, {
...
function useTabs(parameters) {
  ...
  const getTabId2 = React77.useCallback((tabPanelId) => {
...
var TextareaAutosize = React88.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const heightRef = React88.useRef(null);
  const shadowRef = React88.useRef(null);
  const calculateTextareaStyles = React88.useCallback(() => {
  ...
  const syncHeight = React88.useCallback(() => {
  ...
  return (0, import_jsx_runtime40.jsxs)(React88.Fragment, {
...
var TreeItem = React126.forwardRef(function DeprecatedTreeItem() {
  warn37();
  return null;
});
...
var TreeView = React127.forwardRef(function DeprecatedTreeView() {
  warn38();
  return null;
});
...
var Masonry = React128.forwardRef(function Masonry2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiMasonry"
  });
  ...
  const masonryRef = React128.useRef();
  const [maxColumnHeight, setMaxColumnHeight] = React128.useState();
  const isSSR = !maxColumnHeight && defaultHeight && defaultColumns !== void 0 && defaultSpacing !== void 0;
  const [numberOfLineBreaks, setNumberOfLineBreaks] = React128.useState(isSSR ? defaultColumns - 1 : 0);
  const ownerState = {
    ...props,
    spacing,
    columns,
  ...
  const handleResize = React128.useCallback((masonryChildren) => {
  ...
  const lineBreaks = new Array(numberOfLineBreaks).fill("").map((_, index) => (0, import_jsx_runtime63.jsx)("span", {
...
var DialogsContext = React129.createContext(null);
...
function DialogsProvider(props) {
  ...
  const [stack, setStack] = React131.useState([]);
  const keyPrefix = React131.useId();
  const nextId2 = React131.useRef(0);
  const requestDialog = React131.useCallback(function open(Component, payload, options = {}) {
    const {
      onClose = async () => {
      }
    } = options;
  ...
  const closeDialogUi = React131.useCallback(function closeDialogUi2(dialog) {
  ...
  const closeDialog = React131.useCallback(async function closeDialog2(dialog, result) {
...
function useStorageState(area, key, initializer = null, options) {
  ...
  const [initialValue] = React132.useState(initializer);
  const encodedInitialValue = React132.useMemo(() => encode(codec, initialValue), [codec, initialValue]);
  const subscribeKey = React132.useCallback((callback) => subscribe(area, key, callback), [area, key]);
  const getKeySnapshot = React132.useCallback(() => getSnapshot(area, key) ?? encodedInitialValue, [area, encodedInitialValue, key]);
  const encodedStoredValue = React132.useSyncExternalStore(subscribeKey, getKeySnapshot, getKeyServerSnapshot);
  const storedValue = React132.useMemo(() => decode(codec, encodedStoredValue), [codec, encodedStoredValue]);
  const setStoredValue = React132.useCallback((value) => {
  ...
  const [nonStoredValue, setNonStoredValue] = React132.useState(initialValue);
  if (!key) {
...
function LegacyThemeProvider(props) {
  ...
  const dualAwareTheme = React133.useMemo(() => isDualTheme ? theme[paletteMode === "dark" ? "dark" : "light"] ?? theme[paletteMode === "dark" ? "light" : "dark"] : theme, [isDualTheme, paletteMode, theme]);
  const paletteModeContextValue = React133.useMemo(() => ({
    paletteMode,
...
var AuthenticationContext = React134.createContext(null);
var SessionContext = React134.createContext(null);
...
@mui/lab/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-M7DYNP46.js.map
